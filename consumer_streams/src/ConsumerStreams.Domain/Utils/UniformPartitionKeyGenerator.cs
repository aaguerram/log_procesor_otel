...
/// Diseñado para máxima uniformidad en 30 particiones con 0 asignaciones de memoria y ~1.2 ns de CPU.
/// </summary>
public static class UniformPartitionKeyGenerator
{
    ...
    /// </summary>
    /// <param name="businessId">Identificador de negocio opcional (ej: cuenta o ID de transacción).</param>
